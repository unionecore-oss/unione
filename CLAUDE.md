# unione Development Guidelines

Auto-generated from all feature plans. Last updated: 2025-10-16

## Active Technologies
- TypeScript 5 + Next.js 15.5.4 (App Router), Tailwind CSS 4, Framer Motion 12.23, React 19.1 (001-website-ui-refinement)
- TypeScript 5, Next.js 15.5.4 (App Router) + next-intl (i18n for Next.js App Router), React 19.1 (002-korean-language-support)
