...
export default function Hero({
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen w-screen overflow-hidden flex items-start justify-center -mt-[74px] pt-[100px]">
      <ShaderBackground />

      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-6 px-6 pt-20 pb-32 sm:gap-8 md:px-10 lg:px-16">
